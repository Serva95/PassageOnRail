...
class DriversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create driver" do
    assert_difference('Driver.count') do
      post drivers_url, params: { driver: { deleted: @driver.deleted, rating_medio: @driver.rating_medio } }
    end
  ...
  test "should update driver" do
    patch driver_url(@driver), params: { driver: { deleted: @driver.deleted, rating_medio: @driver.rating_medio } }
